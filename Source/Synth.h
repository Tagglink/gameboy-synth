...
static const uint8_t WAVE_TABLE_SIZE = 32;
static const uint8_t WAVE_TABLE_SQUARE[WAVE_TABLE_SIZE] = {
...
// generated with ruby:
// (0...32).map { |i| Math.sin(2*Math::PI*i/32.0) }.map { |v| (v+1)*7.5 }.map(&:round).map { |v| "0x0" + v.to_s(16) }.join(", ")
static const uint8_t WAVE_TABLE_SINE[WAVE_TABLE_SIZE] = {
    0x08, 0x09, 0x0a, 0x0c, 0x0d, 0x0e, 0x0e, 0x0f,
    0x0f, 0x0f, 0x0e, 0x0e, 0x0d, 0x0c, 0x0a, 0x09,
    0x08, 0x06, 0x05, 0x03, 0x02, 0x01, 0x01, 0x00,
    0x00, 0x00, 0x01, 0x01, 0x02, 0x03, 0x05, 0x06,
};


// generated with ruby:
// (0...32).map { |v| v / 2 }.map { |v| "0x0" + v.to_s(16) }.join(", ")
static const uint8_t WAVE_TABLE_SAW[WAVE_TABLE_SIZE] = {
...
// generated with ruby:
// (0...32).map { |v| (v < 16 ? v : 31-v) % 16 }.map { |v| "0x0" + v.to_s(16) }.join(", ")
static const uint8_t WAVE_TABLE_TRIANGLE[WAVE_TABLE_SIZE] = {
...
// generated with ruby:
// (0...32).map { |v| rand * 15 }.map(&:round).map { |v| "0x0" + v.to_s(16) }.join(", ")
static const uint8_t WAVE_TABLE_NOISE[WAVE_TABLE_SIZE] = {
    0x03, 0x08, 0x01, 0x07, 0x03, 0x08, 0x01, 0x0a,
    0x0a, 0x08, 0x0e, 0x0a, 0x0b, 0x05, 0x0b, 0x02,
    0x0d, 0x06, 0x0c, 0x08, 0x06, 0x0b, 0x07, 0x0d,
    0x0a, 0x00, 0x0e, 0x08, 0x0b, 0x04, 0x0a, 0x04,
};
